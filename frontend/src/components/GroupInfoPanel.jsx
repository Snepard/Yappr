...
const GroupInfoPanel = ({ onClose }) => {
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4 sm:p-6 bg-gradient-to-br from-slate-50/60 via-blue-50/40 to-sky-50/50 backdrop-blur-xl overflow-y-auto">
      ...
      <div className="relative w-full max-w-lg sm:max-w-xl bg-white/50 backdrop-blur-2xl backdrop-saturate-200 rounded-3xl shadow-[inset_0_1px_2px_rgba(255,255,255,0.9),0_20px_60px_rgba(14,165,233,0.18)] border border-white/80 overflow-hidden flex flex-col ring-1 ring-sky-500/20 transition-all max-h-[92vh] my-auto">
        ...
        <div className="bg-gradient-to-r from-blue-600 via-sky-600 to-cyan-500 p-5 sm:p-6 text-white text-center relative flex-shrink-0">
          <button
            onClick={handleClose}
            className="absolute top-3.5 left-3.5 sm:top-4 sm:left-4 p-1.5 rounded-full bg-white/20 hover:bg-white/30 text-white transition-colors cursor-pointer flex items-center gap-1 text-xs font-semibold px-3"
            title="Back to Chat"
          >
          ...
          <div className="flex flex-col items-center mt-2">
            <div className="w-20 h-20 sm:w-22 sm:h-22 rounded-2xl overflow-hidden ring-4 ring-white/30 shadow-md mb-3 bg-white/10 flex items-center justify-center">
            ...
            <h2 className="text-xl sm:text-2xl font-bold truncate max-w-xs sm:max-w-sm">{selectedGroup.name}</h2>
        ...
        {/* Tab Navigation */}
        <div className="flex border-b border-sky-100/80 bg-white/60 px-4">
          <button
        ...
        <div className="p-5 sm:p-6 overflow-y-auto flex-1 space-y-4">
          ...
          {activeTab === "members" && (
            <div className="space-y-3">
              ...
              {/* Add Members Panel */}
              {showAddMember && (
                <div className="p-3 bg-sky-50/80 border border-sky-200 rounded-xl space-y-2 animate-in fade-in duration-150">
              ...
              {/* Members List */}
              <div className="divide-y divide-gray-100 border border-sky-100 bg-white/70 rounded-2xl shadow-xs overflow-hidden">
                {selectedGroup.members?.map((member) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Smooth Inline Action Strip (No popups, no scrollbars, no layout distortion) */}
          ...
          {activeTab === "permissions" && isAdmin && (
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-3.5 bg-white/70 border border-sky-100 rounded-2xl shadow-xs">
                  <div>
                ...
                <div className="flex items-center justify-between p-3.5 bg-white/70 border border-sky-100 rounded-2xl shadow-xs">
                  <div>
                    ...
                    <p className="text-[11px] text-gray-500">If disabled, only Admins can send messages (Announcement mode)</p>
                  </div>
                  <input
                    type="checkbox"
          ...
          {activeTab === "edit" && canEditInfo && (
            <form onSubmit={handleSaveInfo} className="space-y-4">
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-[11px] text-gray-400 mt-1.5 font-medium">Click to update group picture</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 text-xs bg-white/80 border border-sky-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/30"
                  required
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3.5 py-2.5 text-xs bg-white/80 border border-sky-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/30 resize-none"
                />
              </div>
              ...
              <div className="pt-2 flex justify-end">
                <button
                  type="submit"
                  disabled={isUpdating}
                  className="px-5 py-2.5 text-xs font-bold text-white bg-gradient-to-r from-blue-600 to-sky-600 hover:from-blue-700 hover:to-sky-700 rounded-xl shadow-md disabled:opacity-50 transition-all cursor-pointer"
                >
          ...
          <div className="pt-4 border-t border-sky-100 flex items-center justify-between">
            <span className="text-[11px] text-gray-400 font-medium">Group ID: {selectedGroup._id}</span>
            <button
              onClick={() => leaveGroup(selectedGroup._id)}
              className="flex items-center space-x-1.5 px-3.5 py-1.5 text-xs font-bold text-red-600 bg-red-50 hover:bg-red-100 rounded-xl transition-colors cursor-pointer"
            >
      ...
      {timeoutTargetUser && (
        ...
        >
          <div
            ...
            className="bg-white w-full max-w-sm rounded-2xl shadow-2xl p-5 border border-amber-200 space-y-4 animate-in fade-in zoom-in-95 duration-150 ease-out transform-gpu"
          >
