          ...
          <div className="backdrop-blur-sm bg-gradient-to-br from-black/40 to-black/20 rounded-3xl shadow-2xl border border-white/20 p-10 transition-all duration-500">
            ...
            <div className="space-y-8">
              ...
              <div className="text-right">
                <button className="text-blue-400 hover:text-blue-300 text-sm font-semibold transition-colors duration-300 hover:underline decoration-2 underline-offset-4 cursor-pointer">
                  Forgot Password?
                </button>
              </div>
